...
var DataProvider = /** @class */ (function () {
    function DataProvider(toastCtrl, http, storage) {
        var _this = this;
    ...
    DataProvider.prototype.presentToast = function (data) {
    ...
    DataProvider.prototype.guardajuego = function (club, adddescripcion) {
        var _this = this;
        ...
        this.http.post('http://comunica7.com/apirestsmartgoal/public/add/juego', this.data)
            ...
            console.log(data);
            _this.presentToast('Seleccione una area');
        }, function (error) {
        });
    };
    ...
    DataProvider.prototype.guardapuntaje = function (codigo, club, jugador, item) {
        var _this = this;
        this.datajugador.addjuego = codigo;
        this.datajugador.addclub = club;
        ...
        this.http.post('http://comunica7.com/apirestsmartgoal/public/add/juegojugadorhistorial', this.datajugador)
            .subscribe(function (data) {
            _this.presentToast('Puntaje Guardado');
        }, function (error) {
        });
    };
    DataProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5_ionic_angular__["k" /* ToastController */], __WEBPACK_IMPORTED_MODULE_0__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_4__ionic_storage__["b" /* Storage */]])
    ], DataProvider);
    return DataProvider;
}());
...
var IngresarPage = /** @class */ (function () {
    ...
    IngresarPage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_5__providers_data_data__["a" /* DataProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__providers_data_data__["a" /* DataProvider */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__ionic_storage__["b" /* Storage */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__ionic_storage__["b" /* Storage */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */]) === "function" && _e || Object])
    ], IngresarPage);
    return IngresarPage;
    var _a, _b, _c, _d, _e;
}());
...
var SeleccionajugadorComponent = /** @class */ (function () {
    function SeleccionajugadorComponent(view, dataprovider, navParams) {
        this.view = view;
        this.dataprovider = dataprovider;
        this.navParams = navParams;
        this.filtro = {};
    ...
    SeleccionajugadorComponent.prototype.empezar = function (data) {
...
var HomePage = /** @class */ (function () {
    function HomePage(dataprovider, http, loadingCtrl, navParams, view, modalCtrl, alertCtrl, platform, toastCtrl, storage, renderer, navCtrl, events, screenOrientation) {
        ...
        this.detallejuego = {};
        this.array_tiro_raso = ['E7', 'F7', 'G7', 'H7', 'I7', 'J7', 'K7', 'L7', 'M7', 'N7', 'NN7', 'O7', 'P7', 'Q7', 'R7'];
        ...
        this.array = [
            ...
            //quinta filaa... f.....
            { 'pastilla': 'F1', 'A': false, 'xin': 5 * a + this.columna_izquierda, 'yin': h + this.margin_alto, 'xfin': 6 * a, 'yfin': h, 'x': 6, 'y': 1 },
            ...
            //quinta filaa... g.....
            { 'pastilla': 'G1', 'A': false, 'xin': 6 * a + this.columna_izquierda, 'yin': h + this.margin_alto, 'xfin': 7 * a, 'yfin': h, 'x': 7, 'y': 1 },
            ...
            //quinta filaa... h.....
            { 'pastilla': 'H1', 'A': false, 'xin': 7 * a + this.columna_izquierda, 'yin': h + this.margin_alto, 'xfin': 8 * a, 'yfin': h, 'x': 8, 'y': 1 },
            ...
            //quinta filaa... I.....
            { 'pastilla': 'I1', 'A': false, 'xin': 8 * a + this.columna_izquierda, 'yin': h + this.margin_alto, 'xfin': 9 * a, 'yfin': h, 'x': 9, 'y': 1 },
            ...
            //quinta filaa... J.....
            { 'pastilla': 'J1', 'A': false, 'xin': 9 * a + this.columna_izquierda, 'yin': h + this.margin_alto, 'xfin': 10 * a, 'yfin': h, 'x': 10, 'y': 1 },
            ...
            //quinta filaa... .k....
            { 'pastilla': 'K1', 'A': false, 'xin': 10 * a + this.columna_izquierda, 'yin': h + this.margin_alto, 'xfin': 11 * a, 'yfin': h, 'x': 11, 'y': 1 },
            ...
            //quinta filaa... L.....
            { 'pastilla': 'L1', 'A': false, 'xin': 11 * a + this.columna_izquierda, 'yin': h + this.margin_alto, 'xfin': 12 * a, 'yfin': h, 'x': 12, 'y': 1 },
            ...
            //quinta filaa... M.....
            { 'pastilla': 'M1', 'A': false, 'xin': 12 * a + this.columna_izquierda, 'yin': h + this.margin_alto, 'xfin': 13 * a, 'yfin': h, 'x': 13, 'y': 1 },
            ...
            //quinta filaa... N.....
            { 'pastilla': 'N1', 'A': false, 'xin': 13 * a + this.columna_izquierda, 'yin': h + this.margin_alto, 'xfin': 14 * a, 'yfin': h, 'x': 14, 'y': 1 },
            ...
            //quinta filaa... NN.....
            { 'pastilla': 'NN1', 'A': false, 'xin': 14 * a + this.columna_izquierda, 'yin': h + this.margin_alto, 'xfin': 15 * a, 'yfin': h, 'x': 15, 'y': 1 },
            ...
            //quinta filaa... O.....
            { 'pastilla': 'O1', 'A': false, 'xin': 15 * a + this.columna_izquierda, 'yin': h + this.margin_alto, 'xfin': 16 * a, 'yfin': h, 'x': 16, 'y': 1 },
            ...
            //quinta filaa... P.....
            { 'pastilla': 'P1', 'A': false, 'xin': 16 * a + this.columna_izquierda, 'yin': h + this.margin_alto, 'xfin': 17 * a, 'yfin': h, 'x': 17, 'y': 1 },
            ...
            //quinta filaa... Q.....
            { 'pastilla': 'Q1', 'A': false, 'xin': 17 * a + this.columna_izquierda, 'yin': h + this.margin_alto, 'xfin': 18 * a, 'yfin': h, 'x': 18, 'y': 1 },
            ...
            ////Tiro Raso..
            { 'tiroraso': false, 'pastilla': 'E7', 'A': false, 'xin': 4 * a + this.columna_izquierda, 'yin': 7 * h + this.margin_alto, 'xfin': 5 * a, 'yfin': 7 * h, 'x': 5, 'y': 7 },
            { 'tiroraso': false, 'pastilla': 'F7', 'A': false, 'xin': 5 * a + this.columna_izquierda, 'yin': 7 * h + this.margin_alto, 'xfin': 6 * a, 'yfin': 7 * h, 'x': 6, 'y': 7 },
            { 'tiroraso': false, 'pastilla': 'G7', 'A': false, 'xin': 6 * a + this.columna_izquierda, 'yin': 7 * h + this.margin_alto, 'xfin': 7 * a, 'yfin': 7 * h, 'x': 7, 'y': 7 },
            { 'tiroraso': false, 'pastilla': 'H7', 'A': false, 'xin': 7 * a + this.columna_izquierda, 'yin': 7 * h + this.margin_alto, 'xfin': 8 * a, 'yfin': 7 * h, 'x': 8, 'y': 7 },
            { 'tiroraso': false, 'pastilla': 'I7', 'A': false, 'xin': 8 * a + this.columna_izquierda, 'yin': 7 * h + this.margin_alto, 'xfin': 9 * a, 'yfin': 7 * h, 'x': 9, 'y': 7 },
            { 'tiroraso': false, 'pastilla': 'J7', 'A': false, 'xin': 9 * a + this.columna_izquierda, 'yin': 7 * h + this.margin_alto, 'xfin': 10 * a, 'yfin': 7 * h, 'x': 10, 'y': 7 },
            { 'tiroraso': false, 'pastilla': 'K7', 'A': false, 'xin': 10 * a + this.columna_izquierda, 'yin': 7 * h + this.margin_alto, 'xfin': 11 * a, 'yfin': 7 * h, 'x': 11, 'y': 7 },
            { 'tiroraso': false, 'pastilla': 'L7', 'A': false, 'xin': 11 * a + this.columna_izquierda, 'yin': 7 * h + this.margin_alto, 'xfin': 12 * a, 'yfin': 7 * h, 'x': 12, 'y': 7 },
            { 'tiroraso': false, 'pastilla': 'M7', 'A': false, 'xin': 12 * a + this.columna_izquierda, 'yin': 7 * h + this.margin_alto, 'xfin': 13 * a, 'yfin': 7 * h, 'x': 13, 'y': 7 },
            { 'tiroraso': false, 'pastilla': 'N7', 'A': false, 'xin': 13 * a + this.columna_izquierda, 'yin': 7 * h + this.margin_alto, 'xfin': 14 * a, 'yfin': 7 * h, 'x': 14, 'y': 7 },
            { 'tiroraso': false, 'pastilla': 'NN7', 'A': false, 'xin': 14 * a + this.columna_izquierda, 'yin': 7 * h + this.margin_alto, 'xfin': 15 * a, 'yfin': 7 * h, 'x': 15, 'y': 7 },
            { 'tiroraso': false, 'pastilla': 'O7', 'A': false, 'xin': 15 * a + this.columna_izquierda, 'yin': 7 * h + this.margin_alto, 'xfin': 16 * a, 'yfin': 7 * h, 'x': 16, 'y': 7 },
            { 'tiroraso': false, 'pastilla': 'P7', 'A': false, 'xin': 16 * a + this.columna_izquierda, 'yin': 7 * h + this.margin_alto, 'xfin': 17 * a, 'yfin': 7 * h, 'x': 17, 'y': 7 },
            { 'tiroraso': false, 'pastilla': 'Q7', 'A': false, 'xin': 17 * a + this.columna_izquierda, 'yin': 7 * h + this.margin_alto, 'xfin': 18 * a, 'yfin': 7 * h, 'x': 18, 'y': 7 },
            { 'tiroraso': false, 'pastilla': 'R7', 'A': false, 'xin': 18 * a + this.columna_izquierda, 'yin': 7 * h + this.margin_alto, 'xfin': 19 * a, 'yfin': 7 * h, 'x': 19, 'y': 7 },
        ];
    ...
    HomePage.prototype.setpastilla = function (data) {
        console.log('setpastilla', data);
    };
    ...
    HomePage.prototype.tiro = function () {
        ...
        this.limpia();
        this.limpiatiroraso();
        console.log('oooo', this.activatiro);
    };
    ...
    HomePage.prototype.selecciona = function (event) {
        console.log('Entre....ajajaj', event, this.activatiro);
        if (this.activatiro == true) {
    ...
    HomePage.prototype.muestracalificacionsecuencia = function () {
        ...
        profileModal.onDidDismiss(function (data) {
            console.log('this.indexjugador', _this.indexjugador, _this.jugadoresseleccionados.length);
            if (_this.indexjugador < _this.jugadoresseleccionados.length) {
                _this.play();
            }
            else {
                console.log('Entre a parar secuencia....');
                _this.parasecuencia();
                _this.muestraplay = false;
    ...
    HomePage.prototype.filtrajugadornombre = function (data) {
        return this.arrayjugadores.filter(function (word) { return word.Jugador == data; });
    };
            ...
            if (_this.numerorepetir) {
                ...
                if (_this.index_numerorepetir == _this.numerorepetir) {
                    ...
                    if (_this.indice_item_extras == _this.item_extras.length) {
                        ////Ultima Puntuacion....
                        _this.dataprovider.listajuegos(_this.club_id).subscribe(function (data) {
                            _this.juegos = data;
                            _this.ultimojuego = data[_this.juegos.length - 1];
                            console.log('I ultimojuego...', _this.ultimojuego, _this.indexjugador, _this.jugadoresseleccionados);
                            var id_jugador = _this.filtrajugadornombre(_this.jugadoresseleccionados[_this.jugadoresseleccionados.length - 1])[0].Codigo;
                            console.log('I calificacion', calificacion);
                            console.log('I club', _this.club_id);
                            console.log('I item', _this.indice_item_extras);
                            _this.dataprovider.guardapuntaje(_this.ultimojuego.Codigo, _this.club_id, id_jugador, _this.indice_item_extras);
    ...
    HomePage.prototype.guardadetallejuego = function () {
        var _this = this;
        if (this.tiposdetiroseleccionados && this.juego) {
            ...
            this.agregatoast('Ingrese Nuevo Juevo / Tipo de tiro');
        }
    };
    ...
    HomePage.prototype.traeultimojuego = function () {
        var _this = this;
        this.dataprovider.listajuegos(this.club_id).subscribe(function (data) {
            _this.juegos = data;
            _this.ultimojuego = data[_this.juegos.length - 1];
        });
    };
    HomePage.prototype.guardapuntaje = function () {
        this.dataprovider.guardapuntaje(1, 1, 1, 1);
    ...
    HomePage.prototype.finaliza = function (event) {
        ...
        if (this.estado_jugador == '') {
            ...
            if (!this.activasecuencia || this.indexsecuencia == 0) {
                var profileModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_8__components_seleccionajugador_seleccionajugador__["a" /* SeleccionajugadorComponent */], { 'activasecuencia': this.activasecuencia, 'array': this.array });
                profileModal.onDidDismiss(function (data) {
                    ...
                    if (data) {
                        ...
                        if (_this.activasecuencia == true) {
                            console.log(data);
                            if (data.estadosecuencia == 'agregasecuencia') {
                                _this.secuencianext(_this.array);
                            }
                            if (data.estadosecuencia == 'finalizasecuencia') {
                                _this.finalizasecuencia();
                            }
                        }
                        else {
                            _this.muestraplay = true;
                        }
                    }
                });
                profileModal.present();
        ...
        var prompt = this.alertCtrl.create({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function (data) {
                        console.log(data);
                        _this.dataprovider.guardajuego(_this.club_id, data.valor);
                    }
                }
            ]
        });
    ...
    HomePage.prototype.agregasecuencia = function () {
        var _this = this;
